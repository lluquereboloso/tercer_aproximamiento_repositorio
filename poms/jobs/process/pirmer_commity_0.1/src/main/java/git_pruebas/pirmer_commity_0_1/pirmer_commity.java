...
package git_pruebas.pirmer_commity_0_1;
 ...
 * @status
 */
public class pirmer_commity implements TalendJob {
	...
	private final String jobName = "pirmer_commity";
	private final String projectName = "GIT_PRUEBAS";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					pirmer_commity.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(pirmer_commity.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final pirmer_commity pirmer_commityClass = new pirmer_commity();

		int exitCode = pirmer_commityClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pirmer_commity.class.getClassLoader()
					.getResourceAsStream("git_pruebas/pirmer_commity_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pirmer_commity.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pirmer_commity");
		}
...
/************************************************************************************************
 * 28918 characters generated by Talend Open Studio for Data Integration on the
 * 18 de septiembre de 2019 15:28:08 CEST
 ************************************************************************************************/